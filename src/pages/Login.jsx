      ...
      <div className="auth-card">
        ...
        <div className="auth-left">
          ...
          <div className="logo-block">
            ...
            <h1 className="left-brand-name">Welcome <em>Back</em></h1>
            <p className="left-brand-tag">Continue your conversations</p>
            ...
            <div className="login-content">
              ...
              <div className="login-message-card">
                ...
                <div>
                  ...
                  <p>Your personal conversations stay private.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="form-section">
          ...
          <div className="panda-chat-wrap">
            ...
            <div className="panda-bubble">
              ...
              <p>
                Hey Buddy! 🐾 <strong>Sign in</strong> to keep chatting.<br />
